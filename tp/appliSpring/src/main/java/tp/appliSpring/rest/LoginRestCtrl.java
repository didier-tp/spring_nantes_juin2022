...
import tp.appliSpring.util.JwtTokenProvider;



@RestController
@RequestMapping(value="/api-bank/public/login" , headers="Accept=application/json")
public class LoginRestCtrl {
	...
	//http://localhost:8080/appliSpring/api-bank/public/login
